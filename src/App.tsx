...
function App() {
  ...
  const {isLoading, error,filterEntries, filteredEntries } = useEntrys();
    ...
    <header className="relative z-20 h-24 bg-black/40 border-b border-white/20">
      <div className="h-full flex items-center justify-between px-8">
        ...
        <div className="flex gap-7">
          ...
          <img src="/icons/sort-arrows.png" className="w-6  opacity-50 hover:opacity-100 transition-all"/>
          <img src="/icons/heart.png" className="w-6  opacity-50 hover:opacity-100 transition-all"/>
        </div>
      </div>
    </header>
